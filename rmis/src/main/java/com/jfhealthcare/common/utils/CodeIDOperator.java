...
public class CodeIDOperator {
	...
	public static long codeToId(String code) {
		...
		if (code.length() == 12) {
			...
			id = Long.valueOf(stringId.substring(1,Integer.parseInt(String.valueOf(stringId.charAt(0))) + 2));
		}
		return id;
	}
	...
	public static void main(String[] args) {
		String sid = "s9n8opvwd48r";
		long id = 1000068123;
		long outInt = CodeIDOperator.codeToId(sid);
